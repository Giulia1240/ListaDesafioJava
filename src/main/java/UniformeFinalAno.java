...
public class Uniform
{
    ...
    public Uniform(String name, String uniformColor, String uniformSize)
    {
        this.name = name;
        this.uniformColor = uniformColor;
        this.uniformSize = uniformSize;
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        scanner.nextLine();
        ArrayList<Uniform> arrayUniforms= new ArrayList<>(N);
        ...
        for(int i = 0; i < N; i++)
        {
            ...
            arrayUniforms.add(new Uniform(name, uniformColor, uniformSize));
        }

        scanner.close();
        Collections.sort(arrayUniforms, new UniformComparator());

        for(Uniform item : arrayUniforms)
        {
            item.printStudentInfos();
        }
    }

    static class UniformComparator implements Comparator<Uniform>
    {
        @Override
        public int compare(Uniform student0, Uniform student1)
        {
